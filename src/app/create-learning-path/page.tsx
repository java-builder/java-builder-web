...
export default function CreateLearningPathPage() {
  ...
  const [learningPathResponse, setLearningPathResponse] =
  ...
  const goals = [
    {
      ...
      desc: "Thăng tiến trong công việc hiện tại",
      icon: "🚀",
    },
    {
      id: "skill",
      label: "Nâng cao kỹ năng",
      desc: "Học thêm kỹ năng mới",
      icon: "💪",
    },
    {
      id: "hobby",
      label: "Sở thích cá nhân",
      desc: "Học vì đam mê và thú vui",
      icon: "🎨",
    },
    {
      id: "certification",
      label: "Lấy chứng chỉ",
      desc: "Có bằng cấp được công nhận",
      icon: "🏆",
    },
    {
      id: "business",
      label: "Khởi nghiệp",
      desc: "Chuẩn bị kiến thức để khởi nghiệp",
      icon: "💼",
    },
    {
      id: "academic",
      label: "Học thuật",
      desc: "Nghiên cứu và học thuật",
      icon: "🎓",
    },
  ];
  ...
  const skills = [
    ...
    },
    {
      id: "marketing",
      label: "Marketing",
      desc: "Digital Marketing, SEO",
      icon: "📈",
    },
    {
      id: "language",
      label: "Ngoại ngữ",
      desc: "Tiếng Anh, Tiếng Nhật, v.v.",
      icon: "🌍",
    },
    {
      id: "business",
    ...
    },
    {
      id: "photography",
      label: "Nhiếp ảnh",
      desc: "Chụp ảnh, Chỉnh sửa",
      icon: "📸",
    },
    {
      id: "music",
      label: "Âm nhạc",
      desc: "Nhạc cụ, Sản xuất nhạc",
      icon: "🎵",
    },
  ];
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await LearningPathService.generateLearningPath({
        message,
      });
  ...
  const isStepValid = () => {
    switch (step) {
      ...
      case 5:
        return preferences.timeCommitment !== "";
      case 6:
        return (
          preferences.specificGoals.trim() !== "" && preferences.timeline !== ""
        );
      default:
        return false;
    }
  ...
  console.log(
    "Has learningPathPlan?",
    !!learningPathResponse?.learningPathPlan,
  );

  if (learningPathResponse?.learningPathPlan) {
    console.log(
      "Rendering LearningPathDisplay with data:",
      learningPathResponse.learningPathPlan,
    );
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center space-x-2 text-gray-600 hover:text-accent-500 transition-colors pb-5"
          >
            <svg
              className="w-5 h-5"
              fill="none"
                ...
                <div className="max-w-md mx-auto space-y-5">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-200 text-base"
                    />
                  </div>
              ...
              <div className="p-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-base text-gray-600">
                    Chọn những mục tiêu bạn muốn đạt được (có thể chọn nhiều)
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
                  {goals.map((goal) => (
                    <button
                      ...
                      className={`p-5 rounded-2xl border transition-all duration-200 text-left hover:bg-gray-50 ${
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 max-w-4xl mx-auto">
                  {skills.map((skill) => (
                    <button
                      ...
                      className={`p-4 rounded-xl border transition-all duration-200 text-left hover:bg-gray-50 ${
              ...
              <div className="p-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">
                    Chọn mức độ kinh nghiệm phù hợp nhất với bạn
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Chưa có kinh nghiệm hoặc rất ít kinh nghiệm",
                      icon: "🌱",
                    },
                    {
                      id: "intermediate",
                      label: "Trung cấp",
                      desc: "Có một số kiến thức cơ bản và kinh nghiệm",
                      icon: "🌿",
                    },
                    {
                      id: "advanced",
                      label: "Nâng cao",
                      desc: "Đã có kinh nghiệm và muốn nâng cao kỹ năng",
                      icon: "🌳",
                    },
                    {
                      id: "expert",
                      label: "Chuyên gia",
                      desc: "Muốn học những kỹ năng chuyên sâu và tiên tiến",
                      icon: "🏔️",
                    },
                  ].map((level) => (
                    <button
                      ...
                      className={`w-full p-5 rounded-2xl border transition-all duration-200 text-left hover:bg-gray-50 ${
            ...
            <MotionWrapper animation="fadeInUp" duration={0.6}>
              <div className="p-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">
                    Bạn có thể dành bao nhiều thời gian mỗi tuần để học?
                  </p>
                </div>
                  ...
                  {[
                    {
                      id: "1-3",
                      label: "1-3 giờ/tuần",
                      desc: "Học nhẹ nhàng, phù hợp với người bận rộn",
                      icon: "🚶",
                    },
                    {
                      id: "4-7",
                      label: "4-7 giờ/tuần",
                      desc: "Cân bằng tốt giữa học tập và công việc",
                      icon: "🏃",
                    },
                    {
                      id: "8-15",
                      label: "8-15 giờ/tuần",
                      desc: "Tập trung học tập, tiến bộ nhanh chóng",
                      icon: "🏃‍♂️",
                    },
                    {
                      id: "15+",
                      label: "15+ giờ/tuần",
                      desc: "Học chuyên sâu, chuyển đổi nghề nghiệp",
                      icon: "🚀",
                    },
                  ].map((time) => (
                    <button
            ...
            <MotionWrapper animation="fadeInUp" duration={0.6}>
              <div className="p-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-base text-gray-600">
                    Chia sẻ thêm để chúng tôi tạo lộ trình phù hợp nhất
                  </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto space-y-6">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-200 resize-none h-32"
                      rows={4}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-200 resize-none h-24"
                      rows={3}
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        ...
                        <button
                          ...
                          className={`p-3 rounded-lg border transition-all duration-200 text-center hover:bg-gray-50 ${
                            preferences.timeline === timeline.id
                              ? "border-accent bg-white shadow"
                              : "border-gray-200"
                          }`}
                        >
            ...
            <div className="p-6 mx-12 mb-6">
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 text-center">
                ...
                <p className="text-blue-700">
                  Vui lòng chờ trong giây lát, AI đang phân tích và tạo lộ trình
                  phù hợp cho bạn.
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              {step < totalSteps ? (
                <button
                  ...
                  className="px-6 py-2.5 bg-accent hover:bg-accent-600 text-white font-semibold rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow"
                >
                  Tiếp tục
                </button>
              ) : (
          ...
          <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full p-6 border border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Bạn cần đăng nhập để tạo lộ trình học tập. Vui lòng đăng nhập để
                tiếp tục.
              </p>
              <div className="flex gap-3 justify-center">
                ...
                <Link
                  href="/login"
                  className="px-6 py-2 bg-accent hover:bg-accent-600 text-white rounded-lg transition-colors font-medium"
                >
                  Đăng nhập
                </Link>
              </div>
