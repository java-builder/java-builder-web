        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="mt-8 sm:mt-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-6 max-w-4xl lg:max-w-none mx-auto">
                {techStack.map((tech, index) => (
                  <div key={index} className="text-center h-full">
                    <div className="bg-white rounded-lg p-4 sm:p-5 lg:p-6 border border-gray-200 hover:shadow-md transition-all duration-300 cursor-pointer group h-full flex flex-col items-center justify-start">
                      <tech.icon className="text-2xl sm:text-3xl lg:text-3xl mb-2 sm:mb-3 text-accent group-hover:scale-110 transition-transform duration-300" />
                      <div className="text-sm sm:text-base lg:text-base font-semibold mb-1 text-gray-900">
                        {tech.name}
                      </div>
                      <div className="text-xs sm:text-sm lg:text-sm text-gray-600 flex-1">
                        {tech.description}
                      </div>
                    </div>
                  </div>
