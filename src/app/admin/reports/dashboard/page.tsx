                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {formatPrice(dashboardData.kpis.totalRevenue)}
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {dashboardData.kpis.totalCourses}
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-accent to-accent-600 rounded-xl p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {dashboardData.kpis.totalEnrollments.toLocaleString()}
                      </p>
                    </div>
                    <div className="bg-accent-400 bg-opacity-30 rounded-lg p-3">
                      <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
