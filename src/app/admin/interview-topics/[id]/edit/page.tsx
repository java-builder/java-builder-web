    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-300 truncate">{name}</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 space-y-4">
                ...
                <div className="space-y-3">
                  {questionSets.map((set) => {
                    ...
                    return (
                      <div
                        key={set.id}
                        className="group border border-gray-200 dark:border-slate-700 rounded-xl p-5 hover:border-accent/60 hover:shadow-sm transition-all bg-white dark:bg-gray-800"
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1 min-w-0 space-y-3">
                            {/* Title row */}
                            <div className="flex items-center gap-2">
                              <h4 className="font-semibold text-base text-gray-900 dark:text-white line-clamp-2 flex-1 leading-snug">
                                {getSetTitle(set)}
                              </h4>
                              {activeLocale && (
                                <span
                            ...
                            <div className="flex items-center gap-2 flex-wrap text-xs">
                              ...
                              <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 font-medium">
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0">
                            <button
                              ...
                              className="p-2 text-gray-500 dark:text-gray-400 hover:text-accent hover:bg-accent/10 rounded-lg transition-colors"
                              title="Chỉnh sửa"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
