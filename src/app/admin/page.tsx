  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Chào mừng trở lại!</h1>
        <p className="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">Đây là tổng quan về hoạt động của hệ thống JavaBuilder hôm nay.</p>
      </div>
