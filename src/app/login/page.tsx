            ...
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              ...
              <Link href="/" className="inline-flex items-center">
                <svg width="36" height="36" viewBox="0 0 64 58" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="loginCupGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" style={{ stopColor: '#0056d2' }} />
                      <stop offset="100%" style={{ stopColor: '#0044aa' }} />
                    </linearGradient>
                  </defs>
                  <g transform="translate(4, 0)">
                    <path d="M16 12C16 12 18 6 16 0" stroke="url(#loginCupGrad)" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.6" />
                    <path d="M24 14C24 14 26 8 24 2" stroke="url(#loginCupGrad)" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.6" />
                    <path d="M32 12C32 12 34 6 32 0" stroke="url(#loginCupGrad)" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.6" />
                    <path d="M8 18H40V42C40 48.627 34.627 54 28 54H20C13.373 54 8 48.627 8 42V18Z" fill="url(#loginCupGrad)" />
                    <path d="M40 24H46C49.314 24 52 26.686 52 30V34C52 37.314 49.314 40 46 40H40" stroke="url(#loginCupGrad)" strokeWidth="4" fill="none" />
