    ...
    const handleLinkedinCallback = async () => {
      ...
      try {
        ...
        if (response.code === 200) {
          ...
          setError("Đăng nhập LinkedIn thất bại");
          setIsProcessing(false);
        }
      } catch (err) {
        setError(
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="flex items-center justify-center w-16 h-16 bg-white rounded-full shadow-md mb-6">
              <svg className="w-8 h-8" viewBox="0 0 24 24">
                ...
                <path d="M7 9h3v7H7zM8.5 7.5a1.5 1.5 0 110-3 1.5 1.5 0 010 3zM14 9c1.657 0 3 1.343 3 3v4h-3v-4c0-.552-.448-1-1s-1 .448-1 1v4h-3v-7h3v1c.33-.644.986-1 1.664-1z" fill="#fff"/>
              </svg>
            </div>
