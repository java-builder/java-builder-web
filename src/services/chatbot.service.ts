...
import { ChatbotRequest, SuggestedBlogResponse, ChatbotResponse } from '@/types/chatbot';
...
export const chatbotApi = {
     ...
     */
    suggestBlogs: async (request: ChatbotRequest): Promise<ApiResponse<SuggestedBlogResponse>> => {
        try {
     ...
     */
    readImage: async (message: string, file: File): Promise<ApiResponse<string>> => {
        try {
