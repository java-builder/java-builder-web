        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center p-4">
                ...
                <div className="relative bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col">
                    {/* Header */}
                    <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-orange-100 rounded-t-xl">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 bg-gray-50 hover:bg-white"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 resize-none bg-gray-50 hover:bg-white"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        {...register('duration', { min: { value: 0, message: 'Thời lượng phải lớn hơn hoặc bằng 0' } })}
                                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 bg-gray-50 hover:bg-white"
                                        placeholder="0"
                                        disabled={isLoading}
                                    />
                            ...
                            <div>
                                ...
                                {imagePreview ? (
                                    ...
                                    <div
                                        ...
                                        className="w-full h-48 border-2 border-dashed border-orange-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-orange-400 hover:bg-orange-50 transition-all duration-200 bg-gray-50"
                                    >
                                        ...
                                        <p className="text-orange-600 text-sm font-medium">Nhấn để chọn ảnh</p>
                                        <p className="text-gray-500 text-xs mt-1">JPG, PNG, GIF. Tối đa 5MB</p>
                                    </div>
                                )}
                    ...
                    <div className="flex justify-end space-x-3 p-6 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 rounded-b-xl">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-200 disabled:opacity-50 flex items-center gap-2 font-medium shadow-lg hover:shadow-xl"
                        >
                            {isLoading ? (
                                <>
