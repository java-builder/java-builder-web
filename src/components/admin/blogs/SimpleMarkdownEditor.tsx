            ...
            <div className={`border rounded-lg overflow-hidden ${error ? 'border-red-300' : 'border-gray-300'}`}>
                ...
                <div className="flex border-b border-gray-200 bg-gray-50">
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium transition-colors duration-200 ${activeTab === 'write'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium transition-colors duration-200 ${activeTab === 'preview'
                            ? 'text-blue-600 border-b-2 border-blue-600 bg-white'
                            : 'text-gray-600 hover:text-gray-800'
                            }`}
                    >
                    ...
                    {activeTab === 'write' ? (
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: value ? markdownToHtml(value) : '<p class="text-gray-400">Không có nội dung để xem trước</p>'
                            }}
                        />
                    )}
                </div>
