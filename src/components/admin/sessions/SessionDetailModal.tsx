    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white rounded-xl shadow-2xl p-6 z-10 ring-1 ring-gray-100 dark:bg-slate-800 dark:ring-0 dark:border dark:border-slate-700">
        ...
        <div className="mt-6 flex gap-2">
          ...
          <button 
            onClick={onClose} 
            className={`${session.status === 'ACTIVE' ? 'flex-1' : 'w-full'} px-3 py-2 bg-white border border-gray-300 text-gray-700 text-sm rounded-lg hover:bg-gray-50 transition-colors font-medium dark:bg-slate-700 dark:border-slate-600 dark:text-white dark:hover:bg-slate-600`}
          >
            Đóng
          </button>
        </div>
