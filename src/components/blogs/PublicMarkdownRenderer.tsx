                                ...
                                <div className="relative group my-4 sm:my-6 shadow-xl rounded-lg sm:rounded-xl overflow-hidden border border-gray-300/30">
                                    ...
                                    <div className="flex items-center justify-between bg-gradient-to-r from-gray-800 to-gray-900 text-gray-300 px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-600/50">
                                        <div className="flex items-center space-x-1.5 sm:space-x-2 min-w-0">
                                            ...
                                            <span className="text-xs sm:text-sm font-semibold text-gray-400 truncate">{language}</span>
                                        </div>
                                        <button
                                    ...
                                    <div className="relative">
                                        <pre className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100 p-3 sm:p-6 overflow-x-auto text-xs sm:text-sm leading-relaxed" style={{ fontFamily: 'ui-monospace, SFMono-Regular, "SF Mono", Consolas, "Liberation Mono", Menlo, monospace' }}>
