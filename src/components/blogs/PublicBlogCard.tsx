...
export default function PublicBlogCard({ blog }: PublicBlogCardProps) {
  ...
  return (
    <article className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-lg hover:border-gray-200 transition-all duration-300 overflow-hidden group">
      {blog.featuredImage && (
