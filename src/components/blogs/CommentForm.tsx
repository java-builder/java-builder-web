                ...
                <div className="flex-1 min-w-0">
                    <div className="relative">
                        <textarea
                            ...
                            className={`w-full p-3 border rounded-lg resize-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-sm placeholder-gray-400 ${isAtLimit
                        ...
                        {/* Character Counter */}
                        <div className={`absolute bottom-2 right-2 text-xs px-2 py-0.5 rounded ${isAtLimit
                    ...
                    <div className="flex items-center justify-end space-x-2 mt-2">
                        ...
                        <button
                            ...
                            className={`px-4 py-1.5 rounded text-sm transition-colors flex items-center space-x-1 ${!content.trim() || isSubmitting || isAtLimit
