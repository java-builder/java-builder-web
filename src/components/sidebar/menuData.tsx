...
export const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      {
        href: "/interview",
        label: "Ôn tập Phỏng vấn",
        labelKey: "sidebar.interview",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        labelKey: "sidebar.verifyCertificate",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        labelKey: "sidebar.doneExercises",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...

      {
        ...
        labelKey: "sidebar.studyProgress",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...

      {
        ...
        label: "Câu hỏi đóng góp",
        labelKey: "sidebar.contributedQuestions",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    titleKey: "sidebar.premiumPayment",
    requireAuth: true,
    defaultOpen: true,
    ...
    items: [
      {
        ...
        label: "Gói Premium của tôi",
        labelKey: "sidebar.myPremium",
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
