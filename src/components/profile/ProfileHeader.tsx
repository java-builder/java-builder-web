                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-3 -right-3 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-gray-100">
                            <div className={`w-7 h-7 rounded-full ${getStatusColor(user.userStatus)} flex items-center justify-center`}>
                            ...
                            <div>
                                ...
                                {user.university && (
                                    <div className="flex items-center gap-3 text-gray-700 mb-4">
                                        ...
                                        <span className="text-lg font-semibold text-gray-800">{user.university}</span>
                                    </div>
                                )}
                                <div className="flex items-center gap-2">
                                    <span className={`px-4 py-2 rounded-full text-base font-medium ${getStatusColor(user.userStatus)}`}>
