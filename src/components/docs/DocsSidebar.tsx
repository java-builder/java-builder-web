                  ...
                  {category.topics.map((topic) => (
                    <li key={topic.id}>
                      <button
                        ...
                        title={topic.title}
                        className="w-full text-left px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-accent hover:bg-gray-50 dark:hover:bg-slate-700/50 rounded-md transition-colors truncate"
                      >
                        {topic.title}
                      </button>
                    </li>
