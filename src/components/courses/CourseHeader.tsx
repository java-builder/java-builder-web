      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-6">
          <div className="flex-1">
            ...
            {course.courseFormat === CourseFormat.TEXT && (
              <div className="mt-4 p-4 bg-accent-50 dark:bg-accent-900/20 border border-gray-200 dark:border-slate-700 rounded-lg">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-10 h-10 bg-accent-100 dark:bg-accent-900/40 rounded-lg flex items-center justify-center">
