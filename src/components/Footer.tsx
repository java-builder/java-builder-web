...
export default function Footer() {
    ...
    return (
        <footer className="bg-gradient-to-b from-gray-900 to-gray-800 border-t border-orange-500 mt-16">
            ...
            <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/about" className="text-gray-300 hover:text-orange-500 text-sm transition-colors duration-200 flex items-center group">
                                    <span className="w-1.5 h-1.5 bg-orange-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Về chúng tôi
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-gray-300 hover:text-orange-500 text-sm transition-colors duration-200 flex items-center group">
                                    <span className="w-1.5 h-1.5 bg-orange-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Liên hệ
                                </Link>
                            </li>
                    ...
                    {/* Support */}
                    <div>
                        <h3 className="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Hỗ trợ</h3>
                        <ul className="space-y-2">
                            <li>
                                <a href="#" className="text-gray-300 hover:text-orange-500 text-sm transition-colors duration-200 flex items-center group">
                                    <span className="w-1.5 h-1.5 bg-orange-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Trung tâm trợ giúp
                                </a>
                            </li>
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex items-center space-x-6 mt-4 md:mt-0">
                        ...
                        <div className="flex items-center space-x-1">
                            ...
                            <span className="text-gray-300 text-sm font-medium">tại Việt Nam</span>
                        </div>
                    </div>
                </div>
            </div>
