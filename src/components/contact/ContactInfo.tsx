...
export default function ContactInfo() {
  const contactMethods = [
    ...
    },
    {
      ...
      title: "Email",
      details: ["support@JavaBuilder.com"],
  ...
  const socialLinks = [
    {
      ...
      url: "https://www.facebook.com/JavaBuilder",
    ...
    },
    {
      ...
      url: "https://www.youtube.com/@JavaBuilder",
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        ...
        <div className="flex space-x-3">
          {socialLinks.map((social, index) => (
            <a
              key={index}
              href={social.url}
              className={`inline-flex items-center justify-center transition-colors duration-200 ${social.color}`}
      ...
      {/* Quick Contact */}
      <div className="mt-8 pt-6 border-t border-gray-200">
        <h4 className="font-semibold text-gray-900 mb-4">Liên hệ nhanh</h4>
        <div className="space-y-3">
          ...
          <a
            href="mailto:support@JavaBuilder.com"
            className="flex items-center space-x-3 p-3 bg-accent/10 text-accent rounded-lg hover:bg-accent/20 transition-colors duration-200"
          >
            <svg
              className="w-6 h-6 text-accent"
