...
export default function ContactInfo() {
    const contactMethods = [
        ...
        },
        {
            ...
            title: 'Email',
            details: ['contact@f-learning.com', 'support@f-learning.com'],
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                    ...
                    >
                        ...
                        <span className="font-medium">Gọi ngay: +84 123 456 789</span>
                    </a>

                    <a
                        href="mailto:contact@f-learning.com"
                    ...
                    >
                        ...
                        <span className="font-medium">Email: contact@f-learning.com</span>
                    </a>
                </div>
            </div>
        </div>
