...
export default function ExerciseListHeader({ totalExercises, quote }: ExerciseListHeaderProps) {
  return (
    <section className="relative overflow-hidden bg-white dark:bg-slate-800">
      <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-purple-500/5 to-blue-500/5 dark:from-accent/20 dark:via-purple-500/20 dark:to-blue-500/20" />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Bài tập{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Thực hành
            </span>
          </h1>
          ...
          {quote && (
            <div className="max-w-2xl mx-auto">
              <div className="bg-white/50 dark:bg-slate-700/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-slate-500">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-accent dark:text-blue-300 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-accent dark:text-blue-300 mt-1 font-medium">
                      — {quote.author}
                    </p>
                  </div>
                </div>
