            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 text-lg mb-8">
                <div className="flex items-center space-x-3 bg-white px-5 py-3 rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">
                      ...
                      {learningPath.timeUnit === "WEEK" ? "tuần" : "tháng"}
                    </div>
                ...
                <div className="flex items-center space-x-3 bg-white px-5 py-3 rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">
                      {learningPath.periods?.length || 0} giai đoạn
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {/* Compact Expand Icon */}
                      <div
                        className={`transform transition-transform duration-300 ${expandedPeriods.has(period.periodNumber) ? "rotate-180" : ""}`}
                      >
                        <svg
                  ...
                  {/* Compact Topics Grid */}
                  {expandedPeriods.has(period.periodNumber) &&
                    period.topics && (
                            ...
                            >
                              ...
                              <div className="flex items-center space-x-3 mb-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-500">
                                    {topicIndex + 1} / {period.topics?.length}
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="grid grid-cols-3 gap-3">
                                ...
                                {(topic.lessons?.length || 0) > 0 && (
                                  ...
                                  >
                                    <div className="text-gray-500 text-2xl mb-2 group-hover/stat:scale-110 transition-transform">
                                      📖
                                    </div>
          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
            <MotionWrapper animation="fadeInUp" duration={300}>
              <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
                {/* Modal Header */}
                <div
                  className={`p-4 bg-white border-b border-gray-200 text-gray-900`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-10 h-10 bg-neutral-100 rounded-lg flex items-center justify-center">
                        <span className="text-2xl">
                          {modalContent.type === "lessons"
                            ? "📖"
                            : modalContent.type === "exercises"
                              ? "💪"
                              : "🧠"}
                        </span>
                      </div>
                                    ...
                                    <div className="space-y-3">
                                      {exercise.instructions.map(
                                        (step, stepIndex) => (
                                          <div
                                            key={stepIndex}
                                            className="flex space-x-3 p-3 bg-white rounded-lg"
                                          >
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start space-x-4">
                              ...
                              <div className="flex-1">
                                <h4 className="font-bold text-gray-900 text-lg mb-6 leading-relaxed">
                                  {quiz.question}
                                </h4>
                                ...
                                <div className="space-y-3 mb-6">
                                  {quiz.options?.map(
                                    (
                                      ...
                                      let buttonClass =
                                        "p-4 rounded-xl border-2 transition-all duration-300 text-left hover:shadow-md cursor-pointer ";
